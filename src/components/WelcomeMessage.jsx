    ...
    return (
        ...
        <div className="">
          <div className="flex justify-end">
            <img src="/mypicture.png" alt="Picture" className="animate-wiggle-2s  w-[100px] [@media(max-width:500px)]:pr-[30px] [@media(max-width:500px)]:pt-[10px]  [@media(min-width:500px)]:w-[140px] sm:w-[160px] md:w-[180px] [@media(min-width:800px)]:w-[200px] [@media(min-width:900px)]:w-[240px] [@media(min-width:1000px)]:w-[360px] [@media(min-width:1000px)]:mr-[60px]"></img>
        </div>
        </div>
        </div>
        </>
